...
params:
   country: "Honduras"
   pre_period_start: '2007-01-01'
   period_period_end: '2010-12-31'
   post_period_start: '2011-01-01'
   post_period_end: '2015-12-01'
   eval_period_start: '2012-01-01' 
   eval_period_end: '2015-12-01'
   year_def: 'cal_year'
   sensitivity: FALSE
   crossval: FALSE
   ...
   denom_name: 'acm_noj_prim' 
   n_seasons: 12
   input_directory: "C:/Users/dmw63/Desktop/"
   file_name: "hr_2_59mo_ByQuarter.csv"
   github.import: FALSE 
...
exclude_covar <- c('J09_J18_prim',
                   'J00_J99_prim' ,'J12_J18_any', 'J13_any','J13_prim','pandemic',
                   'possible_pneumo_code',"population" ,"acm_noj_nodiarr_prim",
                   'A00_A09_prim', 'A30_49_prim', 'A41_prim', 'B95_B98_prim', 
                   'G00_prim', 'G00_G09_prim', 'G00_G99_prim', 'H65_H75_prim',
                   'F00_F99_prim', "O00_O99_prim")      #User-defined list of covariate)      #User-defined list of covariate columns to exclude from all analyses.
...
groups<-groups[groups=="hr 2-59m A"]
...
covars_full<-lapply(covars_full, function(x){
      rand.mat<-as.data.frame(matrix(rnorm(n=10*nrow(x)), ncol=10))
      names(rand.mat)<-paste0('rand', 1:10)
...
##combine estimates
```{r Comparison of estimates from different models, echo=FALSE}
if (crossval){
